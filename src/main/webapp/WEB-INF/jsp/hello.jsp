...
<title>Welcome To JGH DashBoard</title>
...
<body>
    ...
    <header class="intro-header" style="background-image: url('/image/home-bg.jpg')" >
        <div class="container"  style="display:inline">
            <div class="row" >            
                <div class="col-lg-11 col-lg-offset-2 col-md-10 col-md-offset--2" style="display:inline; width:782px;" >
                    <div class="site-heading" >
                        <h1>JGH DashBoard</h1>
                        <hr class="small">
                        <span class="subheading"  style="display:inline;">JGH DashBoard by Start Bootstrap</span>
                    </div>
                </div>
                <div class="col-md-5 col-md-offset--2"  style="display:inline;  width:350px; float:left; padding : 10px -10px 10px 10px">
	<br>
	<br>
